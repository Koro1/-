...
(function() {
  ...
  DynamicAgenda.prototype = {
    ...
    init: function() {
      if (!this.store) {
        this.data = {};
        // Adding additional pre-defined presentations from json file - name starting with pre_built
        // for(obj in app.json.structures){
        //   if(obj.indexOf("pre_built") != -1){
        //     this.data[app.json.structures[obj].name] = app.json.structures[obj];
        //   } 
        // }
        this.mapContent();
      }
